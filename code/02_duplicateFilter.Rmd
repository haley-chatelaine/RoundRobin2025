...
source("/Users/chatelaineha/Documents/Beecher_Collaboration/Writing/data_code/code/duplicate_functions.R")
```
...
lab.rts <- multiplesheets("/Users/chatelaineha/Documents/Beecher_Collaboration/Writing/data_code/data/duplicate_input/overlapmetabs_RT_allLabs.xlsx")
```
...
htmltools::save_html(inchi.int.plots, file = "/Users/chatelaineha/Documents/Beecher_Collaboration/Writing/data_code/outputs/rt_fraction_distribution_intensity_retain.html")
...
htmltools::save_html(inchi.int.plots, file = "/Users/chatelaineha/Documents/Beecher_Collaboration/Writing/data_code/outputs/rt_fraction_distribution_intensity_retain_WITH_standards.html")
...
htmltools::save_html(inchi.rt.plots, file = "/Users/chatelaineha/Documents/Beecher_Collaboration/Writing/data_code/outputs/RTDistributions_fullfilter_WITH_standards_final.html")


match.types <- match.distrib(comp.std)
match.types
htmltools::save_html(match.types, file ="/Users/chatelaineha/Documents/Beecher_Collaboration/Writing/data_code/outputs/match_type_distribution.html")
```

# Save filtered data as RData

```{r}
save(norm.std, comp.std, ratio.std, raw.std, sc.std, mstus.std, meta.data, file = "/Users/chatelaineha/Documents/Beecher_Collaboration/Writing/data_code/data/reproducibility_input/duplicated_filtered_data.RData")
```
...
write.xlsx(comp.report, file = "/Users/chatelaineha/Documents/Beecher_Collaboration/Writing/data_code/outputs/retained_bins.xlsx")
...
write.xlsx(std.feats, file = "/Users/chatelaineha/Documents/Beecher_Collaboration/Writing/data_code/outputs/standards_and_retained_bins.xlsx")
