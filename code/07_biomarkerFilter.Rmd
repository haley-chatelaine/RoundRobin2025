...
png(paste0("./outputs/biomarker_boxplots_", metab, ".png"), width = 1600, height = 400)
par(mfrow = c(1, 8))
...
ggsave("./outputs/biomarker_heatmap.png", heat.arrange, width = 6, height = 4, dpi = 300, units = "in")
```
